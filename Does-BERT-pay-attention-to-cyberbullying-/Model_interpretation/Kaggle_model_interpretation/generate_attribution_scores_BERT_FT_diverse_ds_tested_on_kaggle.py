...
for i in Kaggle_test_df.Text_clean.values:
    s = i.split(" ")[:]
...
model = BertForSequenceClassification.from_pretrained(
    '../../trained_models/BERT-Fine-Tuned/Pytorch/Fine_Tune_Diverse_ds/')
model.to(device)
model.eval()
model.zero_grad()

# load tokenizer
tokenizer = BertTokenizer.from_pretrained('../../trained_models/BERT-Fine-Tuned/Pytorch/Fine_Tune_Diverse_ds/')
...
word_attribution_df.to_csv("attribution_Scores/bert_with_fine_tuning/BERT_FT_on_diverse_ds_tested_on_Kaggle_1000_data_attribution_scores.csv", index=False)
