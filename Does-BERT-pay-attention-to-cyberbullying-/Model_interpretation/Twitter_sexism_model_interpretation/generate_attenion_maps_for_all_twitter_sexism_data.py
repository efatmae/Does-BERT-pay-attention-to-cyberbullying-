...
output_dir = "../../trained_models/BERT-Fine-Tuned/Pytorch/Fine_Tune_Twitter_sexism_clean_text_64/"
...
data_test = pd.read_csv("../../../Data/Twitter_sexism/Twitter_sex_data_test_sample_1000.csv")
