...
Twitter_sexism_test_df = pd.read_csv("../../../Data/Twitter_sexism/Twitter_sexism_test_set_sample_100.csv")
...
for i in Twitter_sexism_test_df.Text_clean.values:
    s = i.split(" ")[:]
...
word_attribution_df.to_csv("attribution_Scores/Fine-tuned_BERT/BERT_FT_on_wtp_agg_tested_on_twitter_sex_1000_data_attribution_scores.csv", index=False)
