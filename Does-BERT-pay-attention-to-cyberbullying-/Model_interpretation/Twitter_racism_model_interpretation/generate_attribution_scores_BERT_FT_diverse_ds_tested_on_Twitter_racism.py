...
word_attribution_df.to_csv("attribution_Scores/Fine-tuned_BERT/BERT_FT_on_diverse_ds_tested_on_Twitter_racism_1000_data_attribution_scores.csv", index=False)
