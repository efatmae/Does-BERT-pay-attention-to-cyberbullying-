...
output_dir = "../../trained_models/BERT-Fine-Tuned/Pytorch/Fine_Tune_Twitter_racism_clean_text_64/"
...
data_test = pd.read_csv("../../../Data/Twitter_racism/Twitter_rac_data_test_sample_1000.csv")
data_test = data_test.dropna()

sentences_lst_tn = data_test.Text_clean_for_BERT.values
