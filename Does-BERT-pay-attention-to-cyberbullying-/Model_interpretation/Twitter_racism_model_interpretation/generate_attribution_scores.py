...
for i in Twitter_racism_test_df.Text_clean_for_BERT.values:
    s = i.split(" ")[:]
...
model = BertForSequenceClassification.from_pretrained(
    '../../trained_models/BERT-Fine-Tuned/Pytorch/Fine_Tune_Twitter_racism_clean_text_64/')
model.to(device)
model.eval()
model.zero_grad()

# load tokenizer
tokenizer = BertTokenizer.from_pretrained('../../trained_models/BERT-Fine-Tuned/Pytorch/Fine_Tune_Twitter_racism_clean_text_64/')
...
word_attribution_df.to_csv("attribution_Scores/Fine-tuned_BERT/Twitter_racism_1000_data_fine_tuned_bert_attribution_scores.csv", index=False)
