...
train_df["oh_label"] = [int(i) for i in train_df.oh_label]
test_df["oh_label"] = [int(i) for i in test_df.oh_label]
...
lr = 2e-5
eps = 1e-8
saver_name = "../../trained_models/BERT-Fine-Tuned/Pytorch/Fine_Tune_Twitter_sexism_clean_text_64"
results_files = "results/BERT_Fine_Tuned/Twitter_sexism_dataset.txt"
...
predicted_dataset.to_csv("../../../Data/Twitter_sexism/Twitter_sex_data_test.csv",index=False)