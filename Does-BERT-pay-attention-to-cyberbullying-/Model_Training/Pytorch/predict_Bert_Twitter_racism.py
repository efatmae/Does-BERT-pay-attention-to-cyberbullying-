...
lr = 2e-5
eps = 1e-8
saver_name = "../../trained_models/custome_pretrained_bert_fine_tuned/Pytorch/Fine_Tune_Twitter_racism_clean_text_64"
results_files = "results/custome_pretrained_bert_fine_tuned/Twitter_racism_dataset.txt"
...
predicted_dataset.to_csv("../../../Data/Twitter_racism/Twitter_rac_data_test.csv",index=False)