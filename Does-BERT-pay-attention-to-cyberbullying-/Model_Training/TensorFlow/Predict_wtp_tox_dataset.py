...
def main(argv):
    ...
    for parameter in models:
        ...
        if parameter == "LR":
            ...
            lr_results_files = "../Results/LR/wp_tox_results.txt"
            ...
            predicted_test_Set.to_csv("../../../Data/wikipedia_toxicity/wp_tox_data_test.csv",index=False)
        ################################################################################################################
        ##MLP model settings
        elif parameter == "MLP_KERAS_EMB":
            ##MLP model settings with Keras embeddings
            saver_path = "../../trained_models/MLP/"
            saver_name = "wp_tox_keras_emb.h5"
            MLP_keras_emb_results_files = "../Results/MLP/wp_tox_results_keras_emb.txt"
        ...
        #####################################################################################################################
            ...
            saver_path = "../../trained_models/MLP/"
            saver_name = "wp_tox_twitter_glove_emb.h5"
            MLP_twitter_glove_results_files = "../Results/MLP/wp_tox_results_twitter_glove.txt"
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/MLP/"
            saver_name = "wp_tox_glove_cc_emb.h5"
            MLP_cc_glove_results_files = "../Results/MLP/wp_tox_results_cc_glove.txt"
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/MLP/"
            saver_name = "wp_tox_sswe_u_emb.h5"
            MLP_sswe_results_files = "../Results/MLP/wp_tox_results_sswe_u.txt"
        ...
        #################################################################################################################
            ...
            saver_path = "../../trained_models/MLP/"
            saver_name = "wp_tox_ud_emb.h5"
            MLP_ud_results_files = "../Results/MLP/wp_tox_results_ud.txt"
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/MLP/"
            saver_name = "wp_tox_glove_wk_emb.h5"
            MLP_glove_wk_results_files = "../Results/MLP/wp_tox_results_glove_wk.txt"
        ...
        #######################################################################################################################
            ...
            saver_path = "../../trained_models/MLP/"
            saver_name = "wp_tox_w2v_emb.h5"
            MLP_w2v_news_results_files = "../Results/MLP/wp_tox_results_w2v_news.txt"
        ...
        ### LSTM model settings ###############
            ...
            saver_name = "wp_tox_keras_emb.h5"
            LSTM_keras_emb_results_files = "../Results/LSTM/wp_tox_results_keras_emb.txt"
        ...
        #####################################################################################################################
            ...
            saver_path = "../../trained_models/LSTM/"
            saver_name = "wp_tox_twitter_glove_emb.h5"
            LSTM_twitter_glove_results_files = "../Results/LSTM/wp_tox_results_twitter_glove.txt"
        ...
        #######################################################################################################################
            ...
            saver_path = "../../trained_models/LSTM/"
            saver_name = "wp_tox_glove_cc_emb.h5"
            LSTM_cc_glove_results_files = "../Results/LSTM/wp_tox_results_cc_glove.txt"
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/LSTM/"
            saver_name = "wp_tox_sswe_u_emb.h5"
            LSTM_sswe_results_files = "../Results/LSTM/wp_tox_results_sswe_u.txt"
        ...
        #################################################################################################################
            ...
            saver_path = "../../trained_models/LSTM/"
            saver_name = "wp_tox_ud_emb.h5"
            LSTM_ud_results_files = "../Results/LSTM/wp_tox_results_ud.txt"
            UD_embeddings_matrix = embeddings.get_UD_embeddings("../../../Data/ud_embeddings/ud_basic.vec",
                                                                              word_dictionary,
                                                                              len(word_dictionary)+1,
                                                                              300)
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/LSTM/"
            saver_name = "wp_tox_glove_wk_emb.h5"
            LSTM_glove_wk_results_files = "../Results/LSTM/wp_tox_results_glove_wk.txt"
        ...
        #######################################################################################################################
            ...
            saver_path = "../../trained_models/LSTM/"
            saver_name = "wp_tox_w2v_emb.h5"
            LSTM_w2v_news_results_files = "../Results/LSTM/wp_tox_results_w2v_news.txt"
        ...
        ### BILSTM model settings ###############
            ...
            saver_name = "wp_tox_keras_emb.h5"
            BiLSTM_keras_emb_results_files = "../Results/BiLSTM/wp_tox_results_keras_emb.txt"
        ...
        #####################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM/"
            saver_name = "wp_tox_twitter_glove_emb.h5"
            BiLSTM_twitter_glove_results_files = "../Results/BiLSTM/wp_tox_results_twitter_glove.txt"
        ...
        #######################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM/"
            saver_name = "wp_tox_glove_cc_emb.h5"
            BiLSTM_cc_glove_results_files = "../Results/BiLSTM/wp_tox_results_cc_glove.txt"
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM/"
            saver_name = "wp_tox_sswe_u_emb.h5"
            BiLSTM_sswe_results_files = "../Results/BiLSTM/wp_tox_results_sswe_u.txt"
        ...
        #################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM/"
            saver_name = "wp_tox_ud_emb.h5"
            BiLSTM_ud_results_files = "../Results/BiLSTM/wp_tox_results_ud.txt"
            UD_embeddings_matrix = embeddings.get_UD_embeddings("../../../Data/ud_embeddings/ud_basic.vec",
                                                                word_dictionary,
                                                                len(word_dictionary) + 1,
                                                                300)
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM/"
            saver_name = "wp_tox_glove_wk_emb.h5"
            BiLSTM_glove_wk_results_files = "../Results/BiLSTM/wp_tox_results_glove_wk.txt"
        ...
        #######################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM/"
            saver_name = "wp_tox_w2v_emb.h5"
            BiLSTM_w2v_news_results_files = "../Results/BiLSTM/wp_tox_results_w2v_news.txt"
        ...
        ### BILSTM_attention model settings ###############
            ...
            saver_name = "wp_tox_keras_emb.h5"
            BiLSTM_atten_keras_emb_results_files = "../Results/BiLSTM_atten/wp_tox_results_keras_emb.txt"
        ...
        #######################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM_atten/"
            saver_name = "wp_tox_glove_cc_emb.h5"
            BiLSTM_att_cc_glove_results_files = "../Results/BiLSTM_atten/wp_tox_results_cc_glove.txt"
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM_atten/"
            saver_name = "wp_tox_sswe_u_emb.h5"
            BiLSTM_att_sswe_results_files = "../Results/BiLSTM_atten/wp_tox_results_sswe_u.txt"
        ...
        #################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM_atten/"
            saver_name = "wp_tox_ud_emb.h5"
            BiLSTM_att_ud_results_files = "../Results/BiLSTM_atten/wp_tox_results_ud.txt"
            UD_embeddings_matrix = embeddings.get_UD_embeddings("../../../Data/ud_embeddings/ud_basic.vec",
                                                                word_dictionary,
                                                                len(word_dictionary) + 1,
                                                                300)
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM_atten/"
            saver_name = "wp_tox_glove_wk_emb.h5"
            BiLSTM_att_glove_wk_results_files = "../Results/BiLSTM_atten/wp_tox_results_glove_wk.txt"
        ...
        #######################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM_atten/"
            saver_name = "wp_tox_w2v_emb.h5"
            BiLSTM_att_w2v_news_results_files = "../Results/BiLSTM_atten/wp_tox_results_w2v_news.txt"
