...
def main(argv):
    ...
    train_df = pd.read_csv("../../../Data/Twitter_racism/Twitter_rac_data_train.csv", index_col=False)
    test_df = pd.read_csv("../../../Data/Twitter_racism/Twitter_rac_data_test.csv", index_col=False)
    ...
    for parameter in models:
        ...
        if parameter == "LR":
            ...
            saver_name = "Twitter_racism.h5"
            lr_results_files = "../Results/LR/Twitter_racism_results.txt"
            ...
            predicted_test_Set.to_csv("../../../Data/Twitter_racism/Twitter_rac_data_test.csv",index=False)
        ################################################################################################################
        ##MLP model settings
        elif parameter == "MLP_KERAS_EMB":
            ##MLP model settings with Keras embeddings
            saver_path = "../../trained_models/MLP/"
            saver_name = "Twitter_racism_keras_emb.h5"
            MLP_keras_emb_results_files = "../Results/MLP/Twitter_racism_results_keras_emb.txt"
        ...
        #####################################################################################################################
            ...
            saver_path = "../../trained_models/MLP/"
            saver_name = "Twitter_racism_twitter_glove_emb.h5"
            MLP_twitter_glove_results_files = "../Results/MLP/Twitter_racism_results_twitter_glove.txt"
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/MLP/"
            saver_name = "Twitter_racism_glove_cc_emb.h5"
            MLP_cc_glove_results_files = "../Results/MLP/Twitter_racism_results_cc_glove.txt"
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/MLP/"
            saver_name = "Twitter_racism_sswe_u_emb.h5"
            MLP_sswe_results_files = "../Results/MLP/Twitter_racism_results_sswe_u.txt"
        ...
        #################################################################################################################
            ...
            saver_path = "../../trained_models/MLP/"
            saver_name = "Twitter_racism_ud_emb.h5"
            MLP_ud_results_files = "../Results/MLP/Twitter_racism_results_ud.txt"
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/MLP/"
            saver_name = "Twitter_racism_glove_wk_emb.h5"
            MLP_glove_wk_results_files = "../Results/MLP/Twitter_racism_results_glove_wk.txt"
        ...
        #######################################################################################################################
            ...
            saver_path = "../../trained_models/MLP/"
            saver_name = "Twitter_racism_w2v_emb.h5"
            MLP_w2v_news_results_files = "../Results/MLP/Twitter_racism_results_w2v_news.txt"
        ...
        ### LSTM model settings ###############
            ...
            saver_name = "Twitter_racism_keras_emb.h5"
            LSTM_keras_emb_results_files = "../Results/LSTM/Twitter_racism_results_keras_emb.txt"
        ...
        #####################################################################################################################
            ...
            saver_path = "../../trained_models/LSTM/"
            saver_name = "Twitter_racism_twitter_glove_emb.h5"
            LSTM_twitter_glove_results_files = "../Results/LSTM/Twitter_racism_results_twitter_glove.txt"
        ...
        #######################################################################################################################
            ...
            saver_path = "../../trained_models/LSTM/"
            saver_name = "Twitter_racism_glove_cc_emb.h5"
            LSTM_cc_glove_results_files = "../Results/LSTM/Twitter_racism_results_cc_glove.txt"
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/LSTM/"
            saver_name = "Twitter_racism_sswe_u_emb.h5"
            LSTM_sswe_results_files = "../Results/LSTM/Twitter_racism_results_sswe_u.txt"
        ...
        #################################################################################################################
            ...
            saver_path = "../../trained_models/LSTM/"
            saver_name = "Twitter_racism_ud_emb.h5"
            LSTM_ud_results_files = "../Results/LSTM/Twitter_racism_results_ud.txt"
            UD_embeddings_matrix = embeddings.get_UD_embeddings("../../../Data/ud_embeddings/ud_basic.vec",
                                                                              word_dictionary,
                                                                              len(word_dictionary)+1,
                                                                              300)
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/LSTM/"
            saver_name = "Twitter_racism_glove_wk_emb.h5"
            LSTM_glove_wk_results_files = "../Results/LSTM/Twitter_racism_results_glove_wk.txt"
        ...
        #######################################################################################################################
            ...
            saver_path = "../../trained_models/LSTM/"
            saver_name = "Twitter_racism_w2v_emb.h5"
            LSTM_w2v_news_results_files = "../Results/LSTM/Twitter_racism_results_w2v_news.txt"
        ...
        ### BILSTM model settings ###############
            ...
            saver_name = "Twitter_racism_keras_emb.h5"
            BiLSTM_keras_emb_results_files = "../Results/BiLSTM/Twitter_racism_results_keras_emb.txt"
        ...
        #####################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM/"
            saver_name = "Twitter_racism_twitter_glove_emb.h5"
            BiLSTM_twitter_glove_results_files = "../Results/BiLSTM/Twitter_racism_results_twitter_glove.txt"
        ...
        #######################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM/"
            saver_name = "Twitter_racism_glove_cc_emb.h5"
            BiLSTM_cc_glove_results_files = "../Results/BiLSTM/Twitter_racism_results_cc_glove.txt"
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM/"
            saver_name = "Twitter_racism_sswe_u_emb.h5"
            BiLSTM_sswe_results_files = "../Results/BiLSTM/Twitter_racism_results_sswe_u.txt"
        ...
        #################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM/"
            saver_name = "Twitter_racism_ud_emb.h5"
            BiLSTM_ud_results_files = "../Results/BiLSTM/Twitter_racism_results_ud.txt"
            UD_embeddings_matrix = embeddings.get_UD_embeddings("../../../Data/ud_embeddings/ud_basic.vec",
                                                                word_dictionary,
                                                                len(word_dictionary) + 1,
                                                                300)
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM/"
            saver_name = "Twitter_racism_glove_wk_emb.h5"
            BiLSTM_glove_wk_results_files = "../Results/BiLSTM/Twitter_racism_results_glove_wk.txt"
        ...
        #######################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM/"
            saver_name = "Twitter_racism_w2v_emb.h5"
            BiLSTM_w2v_news_results_files = "../Results/BiLSTM/Twitter_racism_results_w2v_news.txt"
        ...
        ### BILSTM_attention model settings ###############
            ...
            saver_name = "Twitter_racism_keras_emb.h5"
            BiLSTM_atten_keras_emb_results_files = "../Results/BiLSTM_atten/Twitter_racism_results_keras_emb.txt"
        ...
        #######################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM_atten/"
            saver_name = "Twitter_racism_glove_cc_emb.h5"
            BiLSTM_att_cc_glove_results_files = "../Results/BiLSTM_atten/Twitter_racism_results_cc_glove.txt"
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM_atten/"
            saver_name = "Twitter_racism_sswe_u_emb.h5"
            BiLSTM_att_sswe_results_files = "../Results/BiLSTM_atten/Twitter_racism_results_sswe_u.txt"
        ...
        #################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM_atten/"
            saver_name = "Twitter_racism_ud_emb.h5"
            BiLSTM_att_ud_results_files = "../Results/BiLSTM_atten/Twitter_racism_results_ud.txt"
            UD_embeddings_matrix = embeddings.get_UD_embeddings("../../../Data/ud_embeddings/ud_basic.vec",
                                                                word_dictionary,
                                                                len(word_dictionary) + 1,
                                                                300)
        ...
        ###################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM_atten/"
            saver_name = "Twitter_racism_glove_wk_emb.h5"
            BiLSTM_att_glove_wk_results_files = "../Results/BiLSTM_atten/Twitter_racism_results_glove_wk.txt"
        ...
        #######################################################################################################################
            ...
            saver_path = "../../trained_models/BiLSTM_atten/"
            saver_name = "Twitter_racism_w2v_emb.h5"
            BiLSTM_att_w2v_news_results_files = "../Results/BiLSTM_atten/Twitter_racism_results_w2v_news.txt"
